...
class Gui(ThemedTk):
    ...
    def initGui(self):
       ...
       # self.frame1.config( bg = "azure")
        ...
        self.progressBar = ttk.Progressbar(self.frame1 , style = "Horizontal.green.TProgressbar"   , mode = "determinate")
        ...
        exportButton.grid( row = 5 , column = 6 , sticky = "EW")

        modeButton = ttk.Button( self.frame1 , text = "Light/Dark" + "\n"  "mode" , command = self.mode , width = 10)
        modeButton.grid(row = 6 , column = 6 , sticky = "EW")
    ...
    def initiateProgram(self):
       ...
       # tkMessageBox.showinfo("Program finished",  "The program is finished!") ### führt zu problemen wen das Gui vom user derminated wird, bevor das Program fertig ist
