...
class Gui(ThemedTk):
    ...
    def __init__(self):
        ...
        self.theme = ""
        self.mydata = []
        self.comboBoxList = ["Program1" , "Program2" , "Program3" , "Program4"]
    ...
    def initGui(self):
       ...
       # self.frame1.config( bg = "azure")
        ...
        self.rpmScale = Scale( self.frame1 , from_ = 0 , to = 100 , orient = HORIZONTAL)
        self.rpmScale.grid( row = 1 , column = 3)

        label4 = ttk.Label(self.frame1, text = "TIME(H):")
        label4.grid ( row = 0 , column = 4,  sticky = "EW")
        label4 = ttk.Label(self.frame1 , text = "Scale:")
        label4.grid( row = 1 , column = 4 , sticky = "EW")
        ...
        self.timeScale.grid( row = 1 , column = 5)
        ...
        addButton.grid( row = 0  , column = 6 ,  sticky = "EW" )
        ...
        removeButton.grid( row = 1 , column = 6 , sticky ="EW")
    ...
    def pushData(self):
        ...
        numchosenProgramCombobox = listchosenProgramCombobox[-1]
        main.pullData(numchosenProgramCombobox)
